...
PROCEDURE Value (VAR V100, V10, V1: CHAR);  {Возвращает содержание счетчика}
...
VAR
  ...
  PROCEDURE Start;
    {Сбрасывает счетчик в переменных Ones, Tens, Hudreds в '0'}
    BEGIN{Start}
      Ones := '0';
      Tens := '0';
      Hundreds := '0'
  ...
  {Возвращает содержимое счетчика при помощи полученных переменных Ones, Tens, Hudreds}
    BEGIN {Value}
      V100 := Hundreds;
      V10 := Tens;
      V1 := Ones
