...
PROCEDURE ReadMonth(VAR FIn: TEXT; VAR Mo: Month); {Читает символы и присваивает значение Mo}
PROCEDURE WriteMonth(VAR FOut: TEXT; VAR Mo: Month); {Выводит значение Mo}

IMPLEMENTATION

PROCEDURE ReadMonth(VAR FIn: TEXT; VAR Mo: Month);
{Мы считываем из FIn значения Ch1, Ch2, Ch3 и присваиваем значение Mo. Если входные данные записаны неверно Mo присваиваем NoMonth }
VAR
  Ch1, Ch2, Ch3: CHAR;
BEGIN {ReadMonth}
...
{В соответствии с условием для Mo выводим в выходной файл название месяца. Если это не месяц, то записываем NoMonth }
VAR
  Ch1, Ch2, Ch3: CHAR;
BEGIN {WriteMonth}
